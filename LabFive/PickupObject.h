...
public:
	...
	PickupObject(short allocation_mode, SceneManager* scene_manager, const char* mesh_file_name, Vector3
	...
	void _initialize(SceneManager* scene_manager, const char* mesh_file_name, Vector3 position, Vector3 scale);
